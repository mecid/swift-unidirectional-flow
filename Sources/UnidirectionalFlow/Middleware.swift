...
struct LiftedMiddleware<LiftedState: Sendable, LiftedAction: Sendable, LoweredState: Sendable, LoweredAction: Sendable>: Middleware {
...
struct KeyedMiddleware<KeyedState: Sendable, KeyedAction: Sendable, State: Sendable, Action: Sendable, Key: Hashable & Sendable>: Middleware {
...
struct OffsetMiddleware<IndexedState: Sendable, IndexedAction: Sendable, State: Sendable, Action: Sendable>: Middleware {
    let middleware: any Middleware<State, Action>
